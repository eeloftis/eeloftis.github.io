	<div class="container pt">
		<div class="row mt centered">	
			<div class="col-lg-4">
				<a class="zoom green" href="http:http://www.outofofficediaries.com"><img class="img-responsive" src="/assets/img/portfolio/oood.png" alt="Out of Office Diaries" /></a>
				<p>Samsonite Blog: Out Of Office Diaries</p>
			</div>
			<div class="col-lg-4">
